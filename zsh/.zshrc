...
ZSH_HIGHLIGHT_STYLES[suffix-alias]='fg=#BD93F9'
ZSH_HIGHLIGHT_STYLES[global-alias]='fg=#FF79C6'
...
# ZSH_HIGHLIGHT_STYLES[precommand]='fg=#50FA7B,italic' # i placed it in order not to forget the color
...
plugins=(git tmux aliases alias-finder command-not-found zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting zsh-autocomplete)
